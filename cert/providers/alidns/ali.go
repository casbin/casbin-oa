...
//Derived from https://github.com/go-acme/lego/blob/60ae6e6dc935977d0e9d7b7d965e14384c973c18/providers/dns/alidns/alidnspod.go, modified to comply with the current package use
package alidns
...
func NewDNSProvider() (*DNSProvider, error) {
	...
	config.RAMRole = conf.Config.AliDNS.RAMRole
	config.APIKey = conf.Config.AliDNS.AccessKey
	config.SecretKey = conf.Config.AliDNS.SecretKey
	config.SecurityToken = conf.Config.AliDNS.SecurityToken
