...
func (a *Adapter) createDatabase() error {
	...
	_, err = engine.Exec("CREATE DATABASE IF NOT EXISTS casbin_oa default charset utf8 COLLATE utf8_general_ci")
	return err
}
...
func (a *Adapter) open() {
	...
	engine, err := xorm.NewEngine(a.driverName, a.dataSourceName+"casbin_oa")
	if err != nil {
		panic(err)
	}
