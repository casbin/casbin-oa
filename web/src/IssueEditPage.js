      ...
      <Card size="small" title={
        <div>
          ...
          <Button type="primary" disabled={!Setting.isAdminUser(this.props.account)}
                  onClick={() => this.submitIssueEdit()}>Save</Button>
        </div>
        ...
        <Row style={{marginTop: '20px'}}>
          ...
          <Col span={10}>
            <AutoComplete
              ...
              options={assignees}
              onChange={value => {
                this.updateIssueField('assignee', value)
              }}
            />
          </Col>
        ...
        <Row style={{marginTop: '20px'}}>
          ...
          <Col span={22}>
            <Select
              ...
              onChange={value => {
                this.updateIssueField('at_people', value)
              }}
            >
              {atPeople}
            </Select>
          ...
          <Col span={22}>
            <Select
              ...
              onChange={(value, option) => {
                this.projectChange(value, option)
              }}
            >
              {projectColumns}
            </Select>
    ...
    return (
      <div>
        ...
        <Row style={{margin: 10}}>
          ...
          <Col span={18}>
            <Button type="primary" size="large" disabled={!Setting.isAdminUser(this.props.account)}
                    onClick={this.submitIssueEdit.bind(this)}>Save</Button>
          </Col>
        </Row>
      </div>
    )
